        ...
        <div class="col-lg-8 mx-auto">
            <div class="form-wrapper">
                <div class="table-title">
                    <h2 class="text-uppercase" style="color: var(--app-text);"><b>Edit Data Proyek</b></h2>
                </div>
                ...
                <form action="{{ route('projects.update', $project->id) }}" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="nama_proyek" id="nama_proyek" class="form-control" value="{{ old('nama_proyek', $project->nama_proyek) }}" required>
                    </div>
                        ...
                        <select name="departemen_id" id="departemen_id" class="form-select" required>
                            ...
                            @foreach($departemen as $item)
                                <option value="{{ $item->id }}" 
                                    {{ old('departemen_id', $project->departemen_id) == $item->id ? 'selected' : '' }}>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="date" name="tanggal_mulai" id="tanggal_mulai" class="form-control" value="{{ old('tanggal_mulai', $project->tanggal_mulai) }}" required>
                    </div>

                    <div class="mb-3">
                        <label for="tanggal_selesai" class="form-label">Tanggal Target Selesai (Opsional)</label>
                        <input type="date" name="tanggal_selesai" id="tanggal_selesai" class="form-control" value="{{ old('tanggal_selesai', $project->tanggal_selesai) }}">
                    </div>
